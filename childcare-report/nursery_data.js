...
const nurseries = [
  { name: "いづみ", type: "私立", classification: "認可私立", address: "西新井栄町一丁目15番10号", phone: "03-3886-2520", capacity: 30, hours: "7:30～18:30", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：2名・5歳：4名", features: ["0歳受け入れ","延長保育"], currentStatus: "募集中：4歳2名・5歳4名", reviews: 4.1, reviewSum: "地域密着の小規模保育園。", cost: "要確認", ranking: 4, pros: ["小規模で目が届く"], cons: ["定員が少ない"], lat: 35.775130, lon: 139.7879781 },

  { name: "足立ひまわり", type: "私立", classification: "認可私立", address: "西新井栄町一丁目7番8号", phone: "03-3840-6287", capacity: 110, hours: "7:30～19:00", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：0名・5歳：1名", features: ["延長保育"], currentStatus: "募集中：5歳1名", reviews: 4.0, reviewSum: "駅近で通勤に便利。", cost: "要確認", ranking: 3, pros: ["駅近で利便性◎"], cons: ["人気で競争率高め"], lat: 35.775130, lon: 139.7879781 },
  ...
  { name: "ちゃいれっく西新井駅前", type: "私立", classification: "認可私立", address: "西新井栄町二丁目3番7号", phone: "03-5888-7916", capacity: 60, hours: "7:00～20:00", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：1名・5歳：1名", features: ["駅前立地","延長保育"], currentStatus: "募集中：4歳1名・5歳1名", reviews: 4.0, reviewSum: "駅前で便利だが競争率が高い。", cost: "要確認", ranking: 2, pros: ["通勤に便利"], cons: ["枠が取りにくい"], lat: 35.775130, lon: 139.7879781 },

  { name: "中部ひまわり", type: "私立", classification: "認可私立", address: "関原二丁目10番4号", phone: "03-5845-5702", capacity: 124, hours: "7:30～19:00", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：7名・5歳：5名", features: ["大規模クラス"], currentStatus: "募集中：4歳7名・5歳5名", reviews: 4.0, reviewSum: "定員が多く入りやすさがメリット。", cost: "要確認", ranking: 6, pros: ["定員が多く入りやすい"], cons: ["園児数多め"], lat: 35.766350, lon: 139.7889735 },

  { name: "たんぽぽ保育所西新井南園", type: "私立", classification: "認可私立", address: "関原三丁目31番6号", phone: "03-5845-2511", capacity: 70, hours: "7:30～18:30", feeding: "自園調理", ageSlots: "0歳：0名・1歳：3名・2歳：5名・3歳：0名・4歳：0名・5歳：1名", features: ["家庭的保育"], currentStatus: "募集中：1歳3名・2歳5名・5歳1名", reviews: 3.9, reviewSum: "家庭的で評判の園。", cost: "要確認", ranking: 1, pros: ["家庭的で安心感あり"], cons: ["定員限りあり"], lat: 35.766350, lon: 139.7889735 },
  ...
  { name: "親隣館", type: "私立", classification: "認可私立", address: "梅田四丁目29番6号", phone: "03-3886-6810", capacity: 40, hours: "7:30～19:00", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：4名・5歳：2名", features: ["小規模保育"], currentStatus: "募集中：4歳4名・5歳2名", reviews: 4.0, reviewSum: "小規模でアットホーム。", cost: "要確認", ranking: 8, pros: ["目が届く保育"], cons: ["枠が少ない"], lat: 35.767002, lon: 139.7977934 },
  ...
  { name: "エーワン梅島", type: "私立", classification: "認可私立", address: "梅島一丁目18番3号", phone: "03-3849-0758", capacity: 60, hours: "7:30～18:30", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：1名・3歳：2名・4歳：1名・5歳：2名", features: ["地域密着"], currentStatus: "募集中：2歳1名・3歳2名・4歳1名・5歳2名", reviews: 3.9, reviewSum: "地域に根ざした運営。", cost: "要確認", ranking: 10, pros: ["地域密着で安心"], cons: ["規模は中程度"], lat: 35.7723784, lon: 139.7980832 },
  ...
  { name: "うめだ「子供の家」", type: "私立", classification: "認可私立", address: "梅田七丁目19番23号", phone: "03-3889-8800", capacity: 132, hours: "7:30～19:00", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：1名・4歳：0名・5歳：1名", features: ["大規模保育"], currentStatus: "募集中：3歳1名・5歳1名", reviews: 4.1, reviewSum: "大きめの園で受け入れ幅が広い。", cost: "要確認", ranking: 13, pros: ["受け入れ枠が広い"], cons: ["個別対応に差が出る場合あり"], lat: 35.767002, lon: 139.7977934 },
  ...
  { name: "高和", type: "私立", classification: "認可私立", address: "足立四丁目31番17号", phone: "03-3886-5075", capacity: 80, hours: "7:30～18:30", feeding: "自園調理", ageSlots: "0歳：0名・1歳：0名・2歳：0名・3歳：0名・4歳：0名・5歳：0名", features: ["地域行事重視"], currentStatus: "現状空きなし", reviews: 3.8, reviewSum: "行事が充実している。", cost: "要確認", ranking: 18, lat: 35.761111, lon: 139.808559 },
